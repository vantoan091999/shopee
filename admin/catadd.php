...
<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST'){ //fform đăng nhập dùng phương thức post gửi dữ liệu
		$cateName = $_POST['cateName'];//tạo biến để lấy giữ liệu từ mảng POST
                ...
                ?>
                 <form action="catadd.php" method="post">
                    <table class="form">					
                        <tr>
                            <td>
                                <input type="text" name = 'cateName' placeholder="làm ơn thêm danh mục sản phẩm.." class="medium" />
                            </td>
                        </tr>
						<tr> 
                            <td>
